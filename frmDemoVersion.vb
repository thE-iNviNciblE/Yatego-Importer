Public Class frmDemoVersion
    ...
    Private Sub frmDemoVersion_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        If dDemoEnde < Date.Now Then
            ...
            lblMainMessage.Text = "IHR DEMO VERSION VON " & strProgrammName(1).ToUpper & " IST ABGELAUFEN!" & vbCrLf & vbCrLf & "Bitte Registrieren Sie Ihre Software jetzt um weiter damit arbeiten zu können" & vbCrLf & vbCrLf & "Mit freundlichen Grüßen Bludau Media"
