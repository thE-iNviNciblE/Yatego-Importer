Public Class frmDatenbankEinstellungen
    ...
    Private Sub frmDatenbankEinstellungen_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Catch ex As Exception
            If MessageBox.Show("Fehler bei Load: " & ex.Message & vbCrLf & "Datenbank Einstellungen neuschreiben?", "frmDatenbankEinstellungen_Load", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = System.Windows.Forms.DialogResult.Yes Then
        ...
        Try
            ...
            If frmMain.clsDB.getDBConnect(strCon, False) = True Then
                ...
                If cmbMandant.SelectedIndex = cmbMandant.Items.Count Then
                    ...
                    Me.Close()
                Else
                    If MessageBox.Show("Verbindung von " & strMandant & " wurde erfolgreich gespeichert!" & vbCrLf & vbCrLf & "Möchten Sie einen weiteren Mandanten anlegen?", "Datenbankverbindung " & txtDatenbank.Text & " gespeichert", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
